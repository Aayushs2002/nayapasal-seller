        ...
        <div>
            <nav class="mt-24 ">
                ...
                <a class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform  hover:bg-gray-100"
                    ...
                    <span class="mx-2 text-sm font-medium">Attribute</span>
                </a>
                ...
                <div x-data="{ isOpen: false }" class="relative  w-full inline-block  ">
                    <!-- Dropdown toggle button -->
                    <button @click="isOpen = !isOpen"
                        class="relative z-10 w-full flex justify-between items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform  hover:bg-gray-100">
                        <div class="flex">
                            ...
                            <span class="mx-2 text-sm font-medium">CMS</span>
                        </div>
                    ...
                    <div x-show="isOpen" @click.away="isOpen = false"
                        ...
                        class="absolute left-2 right-0 z-20 w-56 py-2 mt-2 overflow-hidden origin-top-right bg-white  rounded-md shadow-xl ">
                        <a href="#"
