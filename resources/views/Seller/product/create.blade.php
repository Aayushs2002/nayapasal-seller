        ...
        <form method="POST" action="{{ route('seller.product.store') }}" enctype="multipart/form-data">
            ...
            <div class="lg:flex  my-3">
                <div class="p-6 w-full lg:w-7/12 bg-white shadow-sm rounded">
                    ...
                    <div class="mt-4">
                        ...
                        <select id="brand" name="brand"
                            ...
                            @foreach ($brands as $brand)
                                <option class="text-md" value="{{ $brand->id }}"
                    ...
                    <div class="my-3">
                        ...
                        <textarea
                            ...
                            name="description" rows="3">{{ old('description') }}
                        </textarea>
                        @error('description')
                            <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                * {{ $message }}
                    ...
                    <div class="my-3 w-full">
                        ...
                        <div class="flex mt-2">
                            ...
                            <div class="ml-4">
                                <input type="radio" name="customized" value="0" checked>
                                <span class="ml-1">No</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full lg:w-5/12 bg-white lg:ml-3 ">
                    {{-- category --}}
                    @include("Seller.components.product.add-category")

                    {{-- attributes --}}
                    @include("Seller.components.product.add-attribute")
