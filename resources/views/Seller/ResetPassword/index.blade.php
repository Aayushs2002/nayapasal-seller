...
<main id="content" role="main" class="w-full  max-w-md mx-auto p-6">
        ...
        <div class="mt-5">
          <form action="{{ route('seller.resetpasswords') }}" method="POST">
            ...
            <div class="grid gap-y-4">
              ...
              <button type="submit" class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-primary hover:text-primary font-semibold bg-primary text-white hover:bg-white  transition-all text-sm ">Reset password</button>
            </div>
          </form>
        </div>
      </div>
    ...
    <p class="mt-3 flex justify-center items-center text-center divide-x divide-gray-300 dark:divide-gray-700">
      ...
      <a class="pl-3 inline-flex items-center gap-x-2 text-sm text-gray-600 decoration-2 hover:underline hover:text-blue-600 " href="">
