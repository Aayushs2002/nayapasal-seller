                                ...
                                <div class="md:grid grid-cols-3 gap-5">
                                    <div class="flex flex-col gap-2 flex-1 w-full">
                                        ...
                                        <input type="text" name="businessname" id="businessname"
                                            ...
                                            class="input-field bg-white border-[1px] border-[#C2C2C2] rounded-lg px-4 py-[10px] text-16 focus:border-primary focus:outline-none" />
                                        @error('businessname')
                                            <div class="error-message invalid-feedback text-sm text-primary"
                                                style="display: block;">
                                                {{ $message }}
                                    ...
                                    <div class="flex flex-col gap-2 flex-1 w-full">
                                        ...
                                        @error('activities')
                                            <div id="error-message"
                                                class="error-message invalid-feedback text-sm text-primary"
                                                style="display: block;">
                                                {{ $message }}
        ...
        <div class="grid grid-cols-3 gap-x-36 gap-y-10">
            <div class="flex space-x-7">
                ...
                <div class="">
                    ...
                    <p class="text-justify pt-5">Millions of customers on Daraz, Pakistan's most visited shopping
                        destination
                    </p>
                </div>
            </div>
            ...
            <div class="flex space-x-7">
                ...
                <div class="">
                    ...
                    <p class="text-justify pt-5">Learn all about ecommerce for free and get help with seller support and
                        Daraz
                        University</p>
                </div>
            </div>
