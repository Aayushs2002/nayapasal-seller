                    ...
                    <div class="w-full px-4 ">
                        <div class="z-10 w-full p-5 shadow-md bg-gray-50  rounded-lg ">
                            ...
                            <form action="{{ route('seller.loginpost') }}" class="mt-4" method="POST">
                                ...
                                <button
                                    class="w-full g-recaptcha  px-4 py-3 mt-4 font-semibold text-white bg-[#ff2953] rounded-lg hover:text[#ff2953] hover:bg-white border hover:text-[#ff2953] border-[#ff2953]"
